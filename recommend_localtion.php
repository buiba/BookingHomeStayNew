			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="page-title category-title">
						<h1 class="title-head"><a href="#">Chỉ đường</a></h1>
					</div>
													...
													<div id="floating-panel">
														...
														<div class="clearfix">
															<div id="end" class="list-shop">
																...
																<p>Chọn cửa hàng bạn muốn chỉ đường:</p>
																<ul class="no-bullets">
																	...
																	<li data-value="01 Nguyễn Trái, Thanh Xuân, Hà Nội"><i class="fa fa-map-marker" aria-hidden="true"></i> 01 Nguyễn Trái, Thanh Xuân, Hà Nội</li>

																</ul>
															</div>
														</div>
														<div class="clearfix">
															<h3 class="your-address">Nhập địa chỉ muốn bắt đầu:</h3>
